...
function applyPromoBg(el, url){
  ...
  try{
    ...
    if (I && typeof I.applyBgWhenReady === "function"){
      node.style.setProperty("--ecn_promo_bg", "none");
      node.style.backgroundImage = "var(--ecn_promo_bg)";
      return I.applyBgWhenReady(node, "--ecn_promo_bg", u, { timeoutMs: 12000 }).then((ok) => {
